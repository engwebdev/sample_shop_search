            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-xl">
                    <section>
                        <header>
                            ...
                            <p class="mt-1 text-sm text-gray-600">
                                @foreach($product->variations as $variation)
                                    {{$variation->variation_title_name}} = {{$variation->variation_value_name}} + {{$variation->variation_price}} ,
                        ...
                        {{--                        <form--}}
                        {{--                            method="post"--}}
                        {{--                            action="{{ route('cart.add.ajax') }}"--}}
                        {{--                            action="{{ route('cart.remove.ajax') }}"--}}
                        {{--                            id="AddToCartData"--}}
                        ...
                        {{--                                اضافه کردن به سبد خرید و مشاهده سبد--}}
                        {{--                            </x-secondary-button>--}}
                        {{--                        <x-secondary-button--}}
                        {{--                            type="submit" class="btn btn-primary">--}}
                        {{--                            حذف کردن به سبد خرید و مشاهده سبد--}}
                        {{--                        </x-secondary-button>--}}
                        <button type="button"
